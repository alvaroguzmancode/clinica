...
class MedicoController extends AppBaseController
{
    ...
    public function store(CreateMedicoRequest $request)
    {
        $request->validate([
            ...
            'apellido_materno' => 'required|max:250',
            'curp' => 'required|max:250',
            'cedula' => 'required|max:250',
            'profesion' => 'required|max:250',
            'especialidad' => 'required|max:250',
            'fotografia' => 'required|max:250',
            'telefono_fijo' => 'required|max:250',
            'telefono_movil' => 'required|max:250',
            'domicilio' => 'required|max:250',
            'codigo_postal' => 'required|max:250',
            'rfc' => 'required|max:250',
            'numero_seguro_social' => 'required|max:250',
            'email' => 'required',
        ]);
